...
I'm an **AI Automation & Full-Stack Developer** based in Riyadh (originally from Sudan), with **10+ years** in web development and IT. I build systems that work while you sleep — **WhatsApp AI assistants**, lead-capture bots, and end-to-end **n8n automations** — alongside fast, SEO-ready web apps in **React & Next.js**.

My focus is simple: turn repetitive manual work into reliable automated systems that **win customers and save time**. From production LLM agents to WhatsApp Business API integrations, I connect tools into flows that run themselves.

</div>

- 🔭 Building **AI automation systems** — WhatsApp assistants, lead capture, and n8n workflows
- ⚙️ Specializing in **n8n · LLM agents · WhatsApp Business API**
- 🧩 Full-stack with **React, Next.js, TypeScript, Node.js, Supabase**
- 🌐 Website: **[zoheirhassoun.com](https://zoheirhassoun.com)**
- 💬 Ask me about **automation, n8n, AI agents, and building web apps that convert**
- 📫 Reach me at **contact@zoheirhassoun.com**
- 📅 Book a free consultation: **[zoheirhassoun.com](https://zoheirhassoun.com/#booking)**
- ⚡ Fun fact: **I go by Zico**
